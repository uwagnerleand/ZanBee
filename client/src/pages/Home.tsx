...
export default function Home() {
  ...
  return <div className="min-h-screen bg-[#fffaf2] text-[#4b2b1d] selection:bg-[#f5c84b]/40">
    ...
    <footer><div className="container footer-main"><div className="footer-brand"><img src={LOGO} alt="ZanBee"/><p>O lado doce de vestir.</p><span>Óbidos – Pará</span></div><div><h4>Navegue</h4><button onClick={()=>scrollTo("inicio")}>Início</button><button onClick={()=>scrollTo("produtos")}>Produtos</button><button onClick={()=>scrollTo("contato")}>Contato</button></div><div><h4>Fale conosco</h4><a href={WA} target="_blank" rel="noreferrer">(93) 99157-4982</a><a href="https://wa.me/5593991589475" target="_blank" rel="noreferrer">(93) 99158-9475</a><a href="https://instagram.com/zanbeeobidos" target="_blank" rel="noreferrer">@zanbeeobidos</a></div><div className="footer-note"><img src={BEE} alt=""/><p>Moda infantil escolhida com carinho para as famílias de Óbidos.</p></div></div><div className="container footer-bottom"><span>© 2026 ZanBee. Dados de produtos demonstrativos.</span><div className="flex items-center gap-4"><span>Roupas • Calçados • Acessórios</span><a href="/admin" className="inline-flex items-center gap-1 opacity-50 hover:opacity-100 transition-opacity" title="Acesso do Administrador"><Lock size={10}/> <span>Lojista</span></a></div></div></footer>
