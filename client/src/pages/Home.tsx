...
type Product = { id:number; name:string; category:string; price:number; oldPrice?:number; sizes:string[]; colors:string[]; image:string; description:string; badge?:string; soldOut?:boolean };
const products: Product[] = [
  { id:1, name:"Conjunto Infantil Floresta", category:"Meninos", price:40.0, sizes:["6 a 7 anos"], colors:["Verde","Marrom"], image:FLORESTA, description:"Conjunto infantil da coleção Universo Encantado, com estampa da Turma da Floresta e bermuda confortável.", badge:"Universo Encantado", soldOut:true },
  ...
  { id:4, name:"Conjunto Infantil Urso Moderno", category:"Meninos", price:40.0, sizes:["6 a 7 anos"], colors:["Azul","Laranja"], image:URSO, description:"Conjunto infantil descolado da coleção Universo Encantado, com estampa de urso e bermuda vibrante.", badge:"Universo Encantado", soldOut:true },
  { id:5, name:"Conjunto Infantil Dinossauro Explorer", category:"Meninos", price:40.0, sizes:["6 a 7 anos"], colors:["Preto","Azul"], image:DINOSSAURO, description:"Conjunto infantil temático de dinossauro da coleção Universo Encantado, com camiseta preta estampada e bermuda azul.", badge:"Universo Encantado", soldOut:true },
  { id:6, name:"Conjunto Infantil Happy Bear", category:"Meninas", price:40.0, sizes:["6 a 7 anos"], colors:["Rosa","Verde"], image:ESG_BEAR, description:"Conjunto infantil da coleção Universo Encantado, super charmoso com camiseta de urso e bermuda verde.", badge:"Esgotado", soldOut:true },
  { id:7, name:"Conjunto Infantil Picolé & Diversão", category:"Meninas", price:40.0, sizes:["6 a 7 anos"], colors:["Amarelo","Rosa"], image:ESG_PICOLLE, description:"Conjunto leve com camiseta de carrinho de picolé e shorts estampado colorido.", badge:"Esgotado", soldOut:true },
  { id:8, name:"Conjunto Infantil Doce Morango", category:"Meninas", price:40.0, sizes:["6 a 7 anos"], colors:["Creme","Vermelho"], image:ESG_STRAWBERRY, description:"Conjunto infantil delicado com camiseta estampa de morangos e bermuda vermelha.", badge:"Esgotado", soldOut:true },
  { id:9, name:"Conjunto Infantil Cachorrinho Backpack", category:"Meninas", price:40.0, sizes:["6 a 7 anos"], colors:["Lilás","Rosa"], image:ESG_DOG, description:"Conjunto fofo com camiseta estampa mochila de cachorrinho corgi e shorts rosa.", badge:"Esgotado", soldOut:true },
  { id:10, name:"Conjunto Infantil Três Coelhinhos", category:"Meninas", price:40.0, sizes:["6 a 7 anos"], colors:["Rosa","Verde"], image:ESG_RABBITS, description:"Conjunto gracioso com estampa de coelhinhos e bermuda verde com corações.", badge:"Esgotado", soldOut:true }
];
const categories = [
